      ...
      <>
         ...
         <div
            ...
            <ul className="flex flex-col gap-3">
               <a href="#" className="block border-b pt-2 pb-1 border-amber-700 text-lg font-semibold text-start">
                  Inicio
               </a>
               <a href="#" className="block border-b pb-1 border-amber-700 text-lg font-semibold text-start">
                  Sobre
               </a>
               <a href="#" className="block border-b pb-1 border-amber-700 text-lg font-semibold text-start">
                  Menu
